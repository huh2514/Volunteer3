...
public class TimeTable extends AppCompatActivity {
    ...
    boolean mon1_b=false, mon2_b=false, mon3_b=false, mon4_b=false, mon5_b=false, mon6_b=false, mon7_b=false, mon8_b=false, mon9_b=false, mon10_b=false, mon11_b=false, mon12_b=false, mon13_b=false;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        timeTableSaveBtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                final DatabaseReference myRef = database.getReference("customer").child("tiemTable").child(vo.getName() + vo.getEmail());
        ...
        if(mon1_b==false){ mon1.setBackgroundColor(Color.WHITE); }else { mon1.setBackgroundColor(Color.YELLOW);}
        if(mon2_b==false){ mon2.setBackgroundColor(Color.WHITE); }else { mon2.setBackgroundColor(Color.YELLOW);}
        if(mon3_b==false){ mon3.setBackgroundColor(Color.WHITE); }else { mon3.setBackgroundColor(Color.YELLOW);}
        if(mon4_b==false){ mon4.setBackgroundColor(Color.WHITE); }else { mon4.setBackgroundColor(Color.YELLOW);}
        if(mon5_b==false){ mon5.setBackgroundColor(Color.WHITE); }else { mon5.setBackgroundColor(Color.YELLOW);}
        if(mon6_b==false){ mon6.setBackgroundColor(Color.WHITE); }else { mon6.setBackgroundColor(Color.YELLOW);}
        if(mon7_b==false){ mon7.setBackgroundColor(Color.WHITE); }else { mon7.setBackgroundColor(Color.YELLOW);}
        if(mon8_b==false){ mon8.setBackgroundColor(Color.WHITE); }else { mon8.setBackgroundColor(Color.YELLOW);}
        if(mon9_b==false){ mon9.setBackgroundColor(Color.WHITE); }else { mon9.setBackgroundColor(Color.YELLOW);}
        if(mon10_b==false){ mon10.setBackgroundColor(Color.WHITE); }else { mon10.setBackgroundColor(Color.YELLOW);}
        if(mon11_b==false){ mon11.setBackgroundColor(Color.WHITE); }else { mon11.setBackgroundColor(Color.YELLOW);}
        if(mon12_b==false){ mon12.setBackgroundColor(Color.WHITE); }else { mon12.setBackgroundColor(Color.YELLOW);}
        if(mon13_b==false){ mon13.setBackgroundColor(Color.WHITE); }else { mon13.setBackgroundColor(Color.YELLOW);}

        if(tue1_b==false){ tue1.setBackgroundColor(Color.WHITE); }else { tue1.setBackgroundColor(Color.YELLOW);}
        if(tue2_b==false){ tue2.setBackgroundColor(Color.WHITE); }else { tue2.setBackgroundColor(Color.YELLOW);}
        if(tue3_b==false){ tue3.setBackgroundColor(Color.WHITE); }else { tue3.setBackgroundColor(Color.YELLOW);}
        if(tue4_b==false){ tue4.setBackgroundColor(Color.WHITE); }else { tue4.setBackgroundColor(Color.YELLOW);}
        if(tue5_b==false){ tue5.setBackgroundColor(Color.WHITE); }else { tue5.setBackgroundColor(Color.YELLOW);}
        if(tue6_b==false){ tue6.setBackgroundColor(Color.WHITE); }else { tue6.setBackgroundColor(Color.YELLOW);}
        if(tue7_b==false){ tue7.setBackgroundColor(Color.WHITE); }else { tue7.setBackgroundColor(Color.YELLOW);}
        if(tue8_b==false){ tue8.setBackgroundColor(Color.WHITE); }else { tue8.setBackgroundColor(Color.YELLOW);}
        if(tue9_b==false){ tue9.setBackgroundColor(Color.WHITE); }else { tue9.setBackgroundColor(Color.YELLOW);}
        if(tue10_b==false){ tue10.setBackgroundColor(Color.WHITE); }else { tue10.setBackgroundColor(Color.YELLOW);}
        if(tue11_b==false){ tue11.setBackgroundColor(Color.WHITE); }else { tue11.setBackgroundColor(Color.YELLOW);}
        if(tue12_b==false){ tue12.setBackgroundColor(Color.WHITE); }else { tue12.setBackgroundColor(Color.YELLOW);}
        if(tue13_b==false){ tue13.setBackgroundColor(Color.WHITE); }else { tue13.setBackgroundColor(Color.YELLOW);}

        if(wed1_b==false){ wed1.setBackgroundColor(Color.WHITE); }else { wed1.setBackgroundColor(Color.YELLOW);}
        if(wed2_b==false){ wed2.setBackgroundColor(Color.WHITE); }else { wed2.setBackgroundColor(Color.YELLOW);}
        if(wed3_b==false){ wed3.setBackgroundColor(Color.WHITE); }else { wed3.setBackgroundColor(Color.YELLOW);}
        if(wed4_b==false){ wed4.setBackgroundColor(Color.WHITE); }else { wed4.setBackgroundColor(Color.YELLOW);}
        if(wed5_b==false){ wed5.setBackgroundColor(Color.WHITE); }else { wed5.setBackgroundColor(Color.YELLOW);}
        if(wed6_b==false){ wed6.setBackgroundColor(Color.WHITE); }else { wed6.setBackgroundColor(Color.YELLOW);}
        if(wed7_b==false){ wed7.setBackgroundColor(Color.WHITE); }else { wed7.setBackgroundColor(Color.YELLOW);}
        if(wed8_b==false){ wed8.setBackgroundColor(Color.WHITE); }else { wed8.setBackgroundColor(Color.YELLOW);}
        if(wed9_b==false){ wed9.setBackgroundColor(Color.WHITE); }else { wed9.setBackgroundColor(Color.YELLOW);}
        if(wed10_b==false){ wed10.setBackgroundColor(Color.WHITE); }else { wed10.setBackgroundColor(Color.YELLOW);}
        if(wed11_b==false){ wed11.setBackgroundColor(Color.WHITE); }else { wed11.setBackgroundColor(Color.YELLOW);}
        if(wed12_b==false){ wed12.setBackgroundColor(Color.WHITE); }else { wed12.setBackgroundColor(Color.YELLOW);}
        if(wed13_b==false){ wed13.setBackgroundColor(Color.WHITE); }else { wed13.setBackgroundColor(Color.YELLOW);}

        if(thu1_b==false){ thu1.setBackgroundColor(Color.WHITE); }else { thu1.setBackgroundColor(Color.YELLOW);}
        if(thu2_b==false){ thu2.setBackgroundColor(Color.WHITE); }else { thu2.setBackgroundColor(Color.YELLOW);}
        if(thu3_b==false){ thu3.setBackgroundColor(Color.WHITE); }else { thu3.setBackgroundColor(Color.YELLOW);}
        if(thu4_b==false){ thu4.setBackgroundColor(Color.WHITE); }else { thu4.setBackgroundColor(Color.YELLOW);}
        if(thu5_b==false){ thu5.setBackgroundColor(Color.WHITE); }else { thu5.setBackgroundColor(Color.YELLOW);}
        if(thu6_b==false){ thu6.setBackgroundColor(Color.WHITE); }else { thu6.setBackgroundColor(Color.YELLOW);}
        if(thu7_b==false){ thu7.setBackgroundColor(Color.WHITE); }else { thu7.setBackgroundColor(Color.YELLOW);}
        if(thu8_b==false){ thu8.setBackgroundColor(Color.WHITE); }else { thu8.setBackgroundColor(Color.YELLOW);}
        if(thu9_b==false){ thu9.setBackgroundColor(Color.WHITE); }else { thu9.setBackgroundColor(Color.YELLOW);}
        if(thu10_b==false){ thu10.setBackgroundColor(Color.WHITE); }else { thu10.setBackgroundColor(Color.YELLOW);}
        if(thu11_b==false){ thu11.setBackgroundColor(Color.WHITE); }else { thu11.setBackgroundColor(Color.YELLOW);}
        if(thu12_b==false){ thu12.setBackgroundColor(Color.WHITE); }else { thu12.setBackgroundColor(Color.YELLOW);}
        if(thu13_b==false){ thu13.setBackgroundColor(Color.WHITE); }else { thu13.setBackgroundColor(Color.YELLOW);}

        if(fri1_b==false){ fri1.setBackgroundColor(Color.WHITE); }else { fri1.setBackgroundColor(Color.YELLOW);}
        if(fri2_b==false){ fri2.setBackgroundColor(Color.WHITE); }else { fri2.setBackgroundColor(Color.YELLOW);}
        if(fri3_b==false){ fri3.setBackgroundColor(Color.WHITE); }else { fri3.setBackgroundColor(Color.YELLOW);}
        if(fri4_b==false){ fri4.setBackgroundColor(Color.WHITE); }else { fri4.setBackgroundColor(Color.YELLOW);}
        if(fri5_b==false){ fri5.setBackgroundColor(Color.WHITE); }else { fri5.setBackgroundColor(Color.YELLOW);}
        if(fri6_b==false){ fri6.setBackgroundColor(Color.WHITE); }else { fri6.setBackgroundColor(Color.YELLOW);}
        if(fri7_b==false){ fri7.setBackgroundColor(Color.WHITE); }else { fri7.setBackgroundColor(Color.YELLOW);}
        if(fri8_b==false){ fri8.setBackgroundColor(Color.WHITE); }else { fri8.setBackgroundColor(Color.YELLOW);}
        if(fri9_b==false){ fri9.setBackgroundColor(Color.WHITE); }else { fri9.setBackgroundColor(Color.YELLOW);}
        if(fri10_b==false){ fri10.setBackgroundColor(Color.WHITE); }else { fri10.setBackgroundColor(Color.YELLOW);}
        if(fri11_b==false){ fri11.setBackgroundColor(Color.WHITE); }else { fri11.setBackgroundColor(Color.YELLOW);}
        if(fri12_b==false){ fri12.setBackgroundColor(Color.WHITE); }else { fri12.setBackgroundColor(Color.YELLOW);}
        if(fri13_b==false){ fri13.setBackgroundColor(Color.WHITE); }else { fri13.setBackgroundColor(Color.YELLOW);}

        if(sat1_b==false){ sat1.setBackgroundColor(Color.WHITE); }else { sat1.setBackgroundColor(Color.YELLOW);}
        if(sat2_b==false){ sat2.setBackgroundColor(Color.WHITE); }else { sat2.setBackgroundColor(Color.YELLOW);}
        if(sat3_b==false){ sat3.setBackgroundColor(Color.WHITE); }else { sat3.setBackgroundColor(Color.YELLOW);}
        if(sat4_b==false){ sat4.setBackgroundColor(Color.WHITE); }else { sat4.setBackgroundColor(Color.YELLOW);}
        if(sat5_b==false){ sat5.setBackgroundColor(Color.WHITE); }else { sat5.setBackgroundColor(Color.YELLOW);}
        if(sat6_b==false){ sat6.setBackgroundColor(Color.WHITE); }else { sat6.setBackgroundColor(Color.YELLOW);}
        if(sat7_b==false){ sat7.setBackgroundColor(Color.WHITE); }else { sat7.setBackgroundColor(Color.YELLOW);}
        if(sat8_b==false){ sat8.setBackgroundColor(Color.WHITE); }else { sat8.setBackgroundColor(Color.YELLOW);}
        if(sat9_b==false){ sat9.setBackgroundColor(Color.WHITE); }else { sat9.setBackgroundColor(Color.YELLOW);}
        if(sat10_b==false){ sat10.setBackgroundColor(Color.WHITE); }else { sat10.setBackgroundColor(Color.YELLOW);}
        if(sat11_b==false){ sat11.setBackgroundColor(Color.WHITE); }else { sat11.setBackgroundColor(Color.YELLOW);}
        if(sat12_b==false){ sat12.setBackgroundColor(Color.WHITE); }else { sat12.setBackgroundColor(Color.YELLOW);}
        if(sat13_b==false){ sat13.setBackgroundColor(Color.WHITE); }else { sat13.setBackgroundColor(Color.YELLOW);}

        if(sun1_b==false){ sun1.setBackgroundColor(Color.WHITE); }else { sun1.setBackgroundColor(Color.YELLOW);}
        if(sun2_b==false){ sun2.setBackgroundColor(Color.WHITE); }else { sun2.setBackgroundColor(Color.YELLOW);}
        if(sun3_b==false){ sun3.setBackgroundColor(Color.WHITE); }else { sun3.setBackgroundColor(Color.YELLOW);}
        if(sun4_b==false){ sun4.setBackgroundColor(Color.WHITE); }else { sun4.setBackgroundColor(Color.YELLOW);}
        if(sun5_b==false){ sun5.setBackgroundColor(Color.WHITE); }else { sun5.setBackgroundColor(Color.YELLOW);}
        if(sun6_b==false){ sun6.setBackgroundColor(Color.WHITE); }else { sun6.setBackgroundColor(Color.YELLOW);}
        if(sun7_b==false){ sun7.setBackgroundColor(Color.WHITE); }else { sun7.setBackgroundColor(Color.YELLOW);}
        if(sun8_b==false){ sun8.setBackgroundColor(Color.WHITE); }else { sun8.setBackgroundColor(Color.YELLOW);}
        if(sun9_b==false){ sun9.setBackgroundColor(Color.WHITE); }else { sun9.setBackgroundColor(Color.YELLOW);}
        if(sun10_b==false){ sun10.setBackgroundColor(Color.WHITE); }else { sun10.setBackgroundColor(Color.YELLOW);}
        if(sun11_b==false){ sun11.setBackgroundColor(Color.WHITE); }else { sun11.setBackgroundColor(Color.YELLOW);}
        if(sun12_b==false){ sun12.setBackgroundColor(Color.WHITE); }else { sun12.setBackgroundColor(Color.YELLOW);}
        if(sun13_b==false){ sun13.setBackgroundColor(Color.WHITE); }else { sun13.setBackgroundColor(Color.YELLOW);}
        ...
        mon11.setOnClickListener(new View.OnClickListener(){
            ...
            public void onClick(View view) {
                if(mon11_b==false){
                    mon11_b=true;
                    mon11.setBackgroundColor(Color.YELLOW);
                }else {
                    mon11_b=false;
        ...
        mon12.setOnClickListener(new View.OnClickListener(){
            ...
            public void onClick(View view) {
                if(mon12_b==false){
                    mon12_b=true;
                    mon12.setBackgroundColor(Color.YELLOW);
                }else {
                    mon12_b=false;
        ...
        mon13.setOnClickListener(new View.OnClickListener(){
            ...
            public void onClick(View view) {
                if(mon13_b==false){
                    mon13_b=true;
                    mon13.setBackgroundColor(Color.YELLOW);
                }else {
                    mon13_b=false;
        ...
        tue2.setOnClickListener(new View.OnClickListener(){
            ...
            public void onClick(View view) {
                if(tue2_b==false){
                    tue2_b=true;
                    tue2.setBackgroundColor(Color.YELLOW);
                }else {
                    tue2_b=false;
        ...
        tue3.setOnClickListener(new View.OnClickListener(){
            ...
            public void onClick(View view) {
                if(tue3_b==false){
                    tue3_b=true;
                    tue3.setBackgroundColor(Color.YELLOW);
                }else {
                    tue3_b=false;
        ...
        tue4.setOnClickListener(new View.OnClickListener(){
            ...
            public void onClick(View view) {
                if(tue4_b==false){
                    tue4_b=true;
                    tue4.setBackgroundColor(Color.YELLOW);
                }else {
                    tue4_b=false;
        ...
        tue5.setOnClickListener(new View.OnClickListener(){
            ...
            public void onClick(View view) {
                if(tue5_b==false){
                    tue5_b=true;
                    tue5.setBackgroundColor(Color.YELLOW);
                }else {
                    tue5_b=false;
        ...
        tue6.setOnClickListener(new View.OnClickListener(){
            ...
            public void onClick(View view) {
                if(tue6_b==false){
                    tue6_b=true;
                    tue6.setBackgroundColor(Color.YELLOW);
                }else {
                    tue6_b=false;
        ...
        tue7.setOnClickListener(new View.OnClickListener(){
            ...
            public void onClick(View view) {
                if(tue7_b==false){
                    tue7_b=true;
                    tue7.setBackgroundColor(Color.YELLOW);
                }else {
                    tue7_b=false;
        ...
        tue8.setOnClickListener(new View.OnClickListener(){
            ...
            public void onClick(View view) {
                if(tue8_b==false){
                    tue8_b=true;
                    tue8.setBackgroundColor(Color.YELLOW);
                }else {
                    tue8_b=false;
        ...
        tue9.setOnClickListener(new View.OnClickListener(){
            ...
            public void onClick(View view) {
                if(tue9_b==false){
                    tue9_b=true;
                    tue9.setBackgroundColor(Color.YELLOW);
                }else {
                    tue9_b=false;
        ...
        tue10.setOnClickListener(new View.OnClickListener(){
            ...
            public void onClick(View view) {
                if(tue10_b==false){
                    tue10_b=true;
                    tue10.setBackgroundColor(Color.YELLOW);
                }else {
                    tue10_b=false;
        ...
        tue11.setOnClickListener(new View.OnClickListener(){
            ...
            public void onClick(View view) {
                if(tue11_b==false){
                    tue11_b=true;
                    tue11.setBackgroundColor(Color.YELLOW);
                }else {
                    tue11_b=false;
        ...
        tue12.setOnClickListener(new View.OnClickListener(){
            ...
            public void onClick(View view) {
                if(tue12_b==false){
                    tue12_b=true;
                    tue12.setBackgroundColor(Color.YELLOW);
                }else {
                    tue12_b=false;
        ...
        tue13.setOnClickListener(new View.OnClickListener(){
            ...
            public void onClick(View view) {
                if(tue13_b==false){
                    tue13_b=true;
                    tue13.setBackgroundColor(Color.YELLOW);
                }else {
                    tue13_b=false;
        ...
        wed11.setOnClickListener(new View.OnClickListener(){
            ...
            public void onClick(View view) {
                if(wed11_b==false){
                    wed11_b=true;
                    wed11.setBackgroundColor(Color.YELLOW);
                }else {
                    wed11_b=false;
        ...
        wed12.setOnClickListener(new View.OnClickListener(){
            ...
            public void onClick(View view) {
                if(wed12_b==false){
                    wed12_b=true;
                    wed12.setBackgroundColor(Color.YELLOW);
                }else {
                    wed12_b=false;
        ...
        wed13.setOnClickListener(new View.OnClickListener(){
            ...
            public void onClick(View view) {
                if(wed13_b==false){
                    wed13_b=true;
                    wed13.setBackgroundColor(Color.YELLOW);
                }else {
                    wed13_b=false;
        ...
        thu8.setOnClickListener(new View.OnClickListener(){
            ...
            public void onClick(View view) {
                if(thu8_b==false){
                    thu8_b=true;
                    thu8.setBackgroundColor(Color.YELLOW);
                }else {
                    thu8_b=false;
        ...
        thu9.setOnClickListener(new View.OnClickListener(){
            ...
            public void onClick(View view) {
                if(thu9_b==false){
                    thu9_b=true;
                    thu9.setBackgroundColor(Color.YELLOW);
                }else {
                    thu9_b=false;
        ...
        thu10.setOnClickListener(new View.OnClickListener(){
            ...
            public void onClick(View view) {
                if(thu10_b==false){
                    thu10_b=true;
                    thu10.setBackgroundColor(Color.YELLOW);
                }else {
                    thu10_b=false;
        ...
        thu11.setOnClickListener(new View.OnClickListener(){
            ...
            public void onClick(View view) {
                if(thu11_b==false){
                    thu11_b=true;
                    thu11.setBackgroundColor(Color.YELLOW);
                }else {
                    thu11_b=false;
        ...
        thu12.setOnClickListener(new View.OnClickListener(){
            ...
            public void onClick(View view) {
                if(thu12_b==false){
                    thu12_b=true;
                    thu12.setBackgroundColor(Color.YELLOW);
                }else {
                    thu12_b=false;
        ...
        thu13.setOnClickListener(new View.OnClickListener(){
            ...
            public void onClick(View view) {
                if(thu13_b==false){
                    thu13_b=true;
                    thu13.setBackgroundColor(Color.YELLOW);
                }else {
                    thu13_b=false;
        ...
        fri11.setOnClickListener(new View.OnClickListener(){
            ...
            public void onClick(View view) {
                if(fri11_b==false){
                    fri11_b=true;
                    fri11.setBackgroundColor(Color.YELLOW);
                }else {
                    fri11_b=false;
        ...
        fri12.setOnClickListener(new View.OnClickListener(){
            ...
            public void onClick(View view) {
                if(fri12_b==false){
                    fri12_b=true;
                    fri12.setBackgroundColor(Color.YELLOW);
                }else {
                    fri12_b=false;
        ...
        fri13.setOnClickListener(new View.OnClickListener(){
            ...
            public void onClick(View view) {
                if(fri13_b==false){
                    fri13_b=true;
                    fri13.setBackgroundColor(Color.YELLOW);
                }else {
                    fri13_b=false;
        ...
        sat1.setOnClickListener(new View.OnClickListener(){
            ...
            public void onClick(View view) {
                if(sat1_b==false){
                    sat1_b=true;
                    sat1.setBackgroundColor(Color.YELLOW);
                }else {
                    sat1_b=false;
        ...
        sat2.setOnClickListener(new View.OnClickListener(){
            ...
            public void onClick(View view) {
                if(sat2_b==false){
                    sat2_b=true;
                    sat2.setBackgroundColor(Color.YELLOW);
                }else {
                    sat2_b=false;
        ...
        sat3.setOnClickListener(new View.OnClickListener(){
            ...
            public void onClick(View view) {
                if(sat3_b==false){
                    sat3_b=true;
                    sat3.setBackgroundColor(Color.YELLOW);
                }else {
                    sat3_b=false;
        ...
        sat4.setOnClickListener(new View.OnClickListener(){
            ...
            public void onClick(View view) {
                if(sat4_b==false){
                    sat4_b=true;
                    sat4.setBackgroundColor(Color.YELLOW);
                }else {
                    sat4_b=false;
        ...
        sat5.setOnClickListener(new View.OnClickListener(){
            ...
            public void onClick(View view) {
                if(sat5_b==false){
                    sat5_b=true;
                    sat5.setBackgroundColor(Color.YELLOW);
                }else {
                    sat5_b=false;
        ...
        sat6.setOnClickListener(new View.OnClickListener(){
            ...
            public void onClick(View view) {
                if(sat6_b==false){
                    sat6_b=true;
                    sat6.setBackgroundColor(Color.YELLOW);
                }else {
                    sat6_b=false;
        ...
        sat7.setOnClickListener(new View.OnClickListener(){
            ...
            public void onClick(View view) {
                if(sat7_b==false){
                    sat7_b=true;
                    sat7.setBackgroundColor(Color.YELLOW);
                }else {
                    sat7_b=false;
        ...
        sat8.setOnClickListener(new View.OnClickListener(){
            ...
            public void onClick(View view) {
                if(sat8_b==false){
                    sat8_b=true;
                    sat8.setBackgroundColor(Color.YELLOW);
                }else {
                    sat8_b=false;
        ...
        sat9.setOnClickListener(new View.OnClickListener(){
            ...
            public void onClick(View view) {
                if(sat9_b==false){
                    sat9_b=true;
                    sat9.setBackgroundColor(Color.YELLOW);
                }else {
                    sat9_b=false;
        ...
        sat10.setOnClickListener(new View.OnClickListener(){
            ...
            public void onClick(View view) {
                if(sat10_b==false){
                    sat10_b=true;
                    sat10.setBackgroundColor(Color.YELLOW);
                }else {
                    sat10_b=false;
        ...
        sat11.setOnClickListener(new View.OnClickListener(){
            ...
            public void onClick(View view) {
                if(sat11_b==false){
                    sat11_b=true;
                    sat11.setBackgroundColor(Color.YELLOW);
                }else {
                    sat11_b=false;
        ...
        sat12.setOnClickListener(new View.OnClickListener(){
            ...
            public void onClick(View view) {
                if(sat12_b==false){
                    sat12_b=true;
                    sat12.setBackgroundColor(Color.YELLOW);
                }else {
                    sat12_b=false;
        ...
        sat13.setOnClickListener(new View.OnClickListener(){
            ...
            public void onClick(View view) {
                if(sat13_b==false){
                    sat13_b=true;
                    sat13.setBackgroundColor(Color.YELLOW);
                }else {
                    sat13_b=false;
        ...
        sun1.setOnClickListener(new View.OnClickListener(){
            ...
            public void onClick(View view) {
                if(sun1_b==false){
                    sun1_b=true;
                    sun1.setBackgroundColor(Color.YELLOW);
                }else {
                    sun1_b=false;
        ...
        sun2.setOnClickListener(new View.OnClickListener(){
            ...
            public void onClick(View view) {
                if(sun2_b==false){
                    sun2_b=true;
                    sun2.setBackgroundColor(Color.YELLOW);
                }else {
                    sun2_b=false;
        ...
        sun3.setOnClickListener(new View.OnClickListener(){
            ...
            public void onClick(View view) {
                if(sun3_b==false){
                    sun3_b=true;
                    sun3.setBackgroundColor(Color.YELLOW);
                }else {
                    sun3_b=false;
        ...
        sun4.setOnClickListener(new View.OnClickListener(){
            ...
            public void onClick(View view) {
                if(sun4_b==false){
                    sun4_b=true;
                    sun4.setBackgroundColor(Color.YELLOW);
                }else {
                    sun4_b=false;
        ...
        sun5.setOnClickListener(new View.OnClickListener(){
            ...
            public void onClick(View view) {
                if(sun5_b==false){
                    sun5_b=true;
                    sun5.setBackgroundColor(Color.YELLOW);
                }else {
                    sun5_b=false;
        ...
        sun6.setOnClickListener(new View.OnClickListener(){
            ...
            public void onClick(View view) {
                if(sun6_b==false){
                    sun6_b=true;
                    sun6.setBackgroundColor(Color.YELLOW);
                }else {
                    sun6_b=false;
        ...
        sun7.setOnClickListener(new View.OnClickListener(){
            ...
            public void onClick(View view) {
                if(sun7_b==false){
                    sun7_b=true;
                    sun7.setBackgroundColor(Color.YELLOW);
                }else {
                    sun7_b=false;
        ...
        sun8.setOnClickListener(new View.OnClickListener(){
            ...
            public void onClick(View view) {
                if(sun8_b==false){
                    sun8_b=true;
                    sun8.setBackgroundColor(Color.YELLOW);
                }else {
                    sun8_b=false;
        ...
        sun9.setOnClickListener(new View.OnClickListener(){
            ...
            public void onClick(View view) {
                if(sun9_b==false){
                    sun9_b=true;
                    sun9.setBackgroundColor(Color.YELLOW);
                }else {
                    sun9_b=false;
        ...
        sun10.setOnClickListener(new View.OnClickListener(){
            ...
            public void onClick(View view) {
                if(sun10_b==false){
                    sun10_b=true;
                    sun10.setBackgroundColor(Color.YELLOW);
                }else {
                    sun10_b=false;
        ...
        sun11.setOnClickListener(new View.OnClickListener(){
            ...
            public void onClick(View view) {
                if(sun11_b==false){
                    sun11_b=true;
                    sun11.setBackgroundColor(Color.YELLOW);
                }else {
                    sun11_b=false;
        ...
        sun12.setOnClickListener(new View.OnClickListener(){
            ...
            public void onClick(View view) {
                if(sun12_b==false){
                    sun12_b=true;
                    sun12.setBackgroundColor(Color.YELLOW);
                }else {
                    sun12_b=false;
        ...
        sun13.setOnClickListener(new View.OnClickListener(){
            ...
            public void onClick(View view) {
                if(sun13_b==false){
                    sun13_b=true;
                    sun13.setBackgroundColor(Color.YELLOW);
                }else {
                    sun13_b=false;
